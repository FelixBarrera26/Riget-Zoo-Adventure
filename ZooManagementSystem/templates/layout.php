        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse">
          <ul class="navbar-nav ml-auto d-lg-flex align-items-lg-center">
            <li class="nav-item"><a href="home" class="nav-link font-weight-bold px-lg-3 py-lg-4">Home </a>
              ...
              <li class="nav-item"><a href="register_visitor" class="nav-link font-weight-bold px-lg-3 py-lg-4">Register </a>
              </li>
    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-lg-8 col-md-6 mb-4">
          <h5 class="lined lined-dark color-header mb-3 color-header">About Riget Zoo Adventures</h5>
          <p class="text-muted text-small">Riget Zoo Adventures, an international science-driven conservation charity, working to restore wildlife in the UK and around the world.</p>
        ...
        <div class="col-lg-4 col-md-6">
          <h5 class="lined lined-dark mb-3 color-header">Site Information</h5>
          <ul class="list-unstyled">
            <li><a href="#" class="footer-link text-small">Privacy Policy</a></li>
            <li><a href="#" class="footer-link text-small">Terms & Conditions</a></li>
            <li><a href="#" class="footer-link text-small">Cookie Information</a></li>
          </ul>
          </p>
        </div>
      </div>
